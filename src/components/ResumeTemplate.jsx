      ...
      <div style={{ position: 'absolute', left: '-9999px', top: 0 }}>
        <div id="resume-template" style={{
          ...
          <div style={{ fontSize: '10pt', marginBottom: '15px' }}>
            ...
            <p style={{ margin: '3px 0' }}><strong>Backend:</strong> Node.js, Express.js, REST APIs.</p>
          ...
          <div style={{ marginBottom: '12px' }}>
            <p style={{ margin: '0', fontWeight: 'bold' }}>X (Twitter) Clone | MERN Stack</p>
          ...
          <div style={{ marginBottom: '12px' }}>
            <p style={{ margin: '0', fontWeight: 'bold' }}>Netflix Clone | React, Firebase, Tailwind CSS </p>
            <ul style={{ margin: '0', fontSize: '10pt', paddingLeft: '20px' }}>
              <li>Developed a high-fidelity streaming UI using TMDB API with search and responsive layouts.</li>
            </ul>
          </div>
          ...
          <div style={{ marginBottom: '12px' }}>
            <p style={{ margin: '0', fontWeight: 'bold' }}>Password Manager | React, Node.js </p>
            <ul style={{ margin: '0', fontSize: '10pt', paddingLeft: '20px' }}>
              <li>Engineered an encrypted credential vault with master-key protection.</li>
            </ul>
          </div>
          <div style={{ marginBottom: '12px' }}>
            <p style={{ margin: '0', fontWeight: 'bold' }}>URL Shortener  | Node.js, Express.js, MongoDB  </p>
            <ul style={{ margin: '0', fontSize: '10pt', paddingLeft: '20px' }}>
              <li>Developed backend service to generate short, trackable URLs with redirection logic. </li>
            </ul>
          </div>
          <div style={{ marginBottom: '12px' }}>
            <p style={{ margin: '0', fontWeight: 'bold' }}>To-Do List Application  | React, JavaScript, CSS  </p>
            <ul style={{ margin: '0', fontSize: '10pt', paddingLeft: '20px' }}>
              <li>Built task management app with CRUD functionality and local storage. </li>
            </ul>
          </div>
